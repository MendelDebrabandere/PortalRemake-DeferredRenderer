...
//
//
//PortalGun::PortalGun(Character* character)
...
//
//		//Spawn new portal
//		auto portal = scene->AddChild(new Portal(type, m_PortalMaterialPtrs[int(type)], m_PortalPtrs[int(otherType)], m_pCharacter));
